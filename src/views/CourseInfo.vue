                ...
                <li v-show="current==='page1'">
                    <div class="all-comment">
                        ...
                        <div class="public-style-info">
                            <span class="name">谢顿宁</span>
                            <span class="att-number">7人关注</span>
                            <span class="attention"><a href="javascript:;">关注</a> </span>
                            <br>
                            <span class="teacher-info">世界海关组织认证培训师、联合国安理会贸易管制专家智库成员。国际贸易与海事事务专家、世界海关组织认证培训师、联合国安理会贸易管制专家智库成员。十一年中国海关工作经验，主要研究领域包括：商品归类、海关估价、原产地规则、风险管理、贸易管制等，曾为中国入世谈判提供智力支持。受国内外多个平台和机构邀请，常年为社会各界提供：理论研究、政策咨询、专题演讲、培训辅导等专业服务。</span>
                        </div>
                        <div class="clear"></div>
                        <p class="title">课程背景</p>
                        <p class="info">2018年是美国对外贸易政策发生剧变的一年。在出口管制领域，美国政府多管齐下，全面加强了整个出口管制体系的立法与执法。</p>
                        <p class="title">课程受众</p>
                        <p class="info">企业如何理解和掌握这些新政的要义，并结合自身的产品与业务特点制定和完善相应的贸易合规制度，在保障生产经营活动的连续性和稳定性的同时有效控制合规风险？</p>
                    ...
                    <div class="all-comment">
                        ...
                        <div class="con-wrapper">
                            ...
                            <div class="public-style-info">
                                ...
                                <span class="att-number">2018-12-05 19:10</span>
                                <br>
                                <span class="teacher-info">全是干货，支持。</span>
                            </div>
                            <div class="clear"></div>
                        </div>
                        <div class="con-wrapper">
                        ...
                        <div class="con-wrapper">
                            ...
                            <div class="public-style-info">
                                ...
                                <span class="att-number">2018-12-05 19:10</span>
                                <br>
                                <span class="teacher-info">具体的实现是通过getElementsByTagName方法，先对选项卡三个标头H3进行捕获，产生一个数组，我们利用for循环分别对每个标头选项H3添加一个index属性作为它的序号同时注册单击事件，当某个H3被单击时，我们先把所有的H3都变成原始状态，没active类，然后再把被单击的H3要添加一个active类使其变成白色，此时，我们还要知道被单击H3的序号，这样我们可以去，设定与之序号相同的DIV显示出来，而其它的DIV刚隐藏起来。</span>
                            </div>
                            <div class="clear"></div>
                        </div>
...
<style>
    ...
    .projectplay .right .title {
        color: #222222;
        font-size: 20px;
    }

    .content, .Cname, .Caddress {
        color: #666666;
        font-size: 0.75rem;
    }
